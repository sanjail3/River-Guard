...
TensorFlow.js:
    $ cd .. && git clone https://github.com/zldrobit/tfjs-yolov5-example.git && cd tfjs-Utility_dir-example
    $ npm install
    $ ln -s ../../Utility_dir/yolov5s_web_model public/yolov5s_web_model
    $ npm start
"""
...
def run(
    ...
    if any(f):
        ...
        LOGGER.info(f'\nExport complete ({time.time() - t:.1f}s)'
                    ...
                    f"\nPyTorch Hub:     model = torch.hub.load('ultralytics/Utility_dir', 'custom', '{f[-1]}')  {s}"
